...
class VocabEntry(object):
    ...
    # self[word] will call this function
    ...
    # '->' This symbol is usually placed after the function 
    # Add metadata to the function to describe the return type of it
    def to_input_tensor(self, sents: List[List[str]], device: torch.device) -> torch.Tensor:
        ...
        sents_var = torch.tensor(sents_t, dtype=torch.long, device=device) # (batch_size, max_sentence_length)
        # Transposition
